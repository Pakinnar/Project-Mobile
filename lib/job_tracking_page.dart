...
import 'job_detailapplicants_page.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildIconDetail(
                    ...
                    'วันที่ทำงาน',
                    '25 พฤศจิกายน 2566 | 09:00 - 12:00 น.',
                  ),
                  ...
                  Text(
                    job['desc'] ?? 'ต้องการช่างล้างแอร์แบบติดผนัง...',
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => JobDetailApplicantsPage(job: job),
                          ),
                        );
                      },
                      child: const Text(
    ...
    return Container(
      ...
      child: Row(
        children: [
          const CircleAvatar(
            radius: 25,
            backgroundImage: NetworkImage('https://i.pravatar.cc/150?u=shang'),
          ),
          const SizedBox(width: 15),
          const Expanded(
            child: Column(
